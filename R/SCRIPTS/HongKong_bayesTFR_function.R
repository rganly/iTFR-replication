...
## The qx values used are based on coale-demeny life tables and located in table 5.3 and calculated ast l5/l0.
...
bayesTFR= function(D){
load(file='DATA/svd.constants.RData')
m = svd.constants$m
X = svd.constants$X
